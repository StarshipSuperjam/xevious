...
| ECO-02 | Score and life HUD | present | ECO-01, ECO-03 | main: `display_player_scores`, `display_high_score`, `display_solvalou_left`; sub: `sub_fn_6__display_1UP_2UP` | Displayed values match internal score, player, and remaining craft. Score and high score render as digit-costume clones and remaining craft as life icons — from the CC BY 3.0 HUD font — with flashing 1UP and HIGH SCORE labels ([012](mechanics/012-hud.md)); the on-stage layout and the reserve-vs-total life convention are playtest-tuned. |
