...
| — built as the slice-8 PR (Closes #65, #66, #57, #58, #59, #61, #62, #63, #64; Part of #60) | Delivered the first live enemy end to end: the formation spawner refilling flying slots (AIR-01/AREA-02, record 024), the homing-aim tables and per-slot fields (record 023), the Toroid's aim-approach / lateral swing / flap / cull, the blaster-to-air hit with the 30-point award and explosion (WPN-02/ECO-01/SYS-03, record 025), the shooting variant's single aimed bullet and the enemy-bullet flight/cull (AIR-12.standard, record 026), and real player death from a Toroid or a bullet touching the craft (PLY-02.air-trigger, record 026) — retiring the debug D/G death keys and the S scoring fixture, and making SYS-02/SYS-03/SYS-04 live through the first enemy consumer. Deferred, recorded: the fire-permission-gated fire rate (DIF-03.play, #60, slice 10), the `add_object` flying branch (Torkan/Kapi/Terrazi, slice 10), radiating bullets and Bacura-vs-craft (slice 11), the bullet colour pulse and dedicated enemy crops (a later art pass), and the flying-enemy hit sound (slice 20 audio). #60 stays open (reassigned to slice 10); a tracked follow-up covers the `add_object` air-dispatch path. Records 023–026. | | |
