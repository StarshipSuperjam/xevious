...
class SpriteExtractorTests(unittest.TestCase):
    ...
    def test_manifest_and_committed_outputs_are_current(self) -> None:
        ...
        # frames (GND-07; the scripted-path shooter's own sprite set)), plus the slice-14 addition —
        # 7 Sol Tower rise frames (SEC-01; the destroy stage reuses the shared explosion burst + crater).
